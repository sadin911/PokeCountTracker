...
export const STATUS_INFO: Record<StatusCondition, StatusInfo> = {
  ...
  asleep:     { condition: 'asleep',     label: 'Asleep',    emoji: '💤', color: 'text-blue-300',   bgColor: 'bg-blue-900',    borderColor: 'border-blue-500',   rule: 'Cannot attack or retreat.',                                                                     cure: 'Flip between turns — heads: wake up. Or Evolve.' },
  paralyzed:  { condition: 'paralyzed',  label: 'Paralyzed', emoji: '⚡', color: 'text-yellow-300', bgColor: 'bg-yellow-900',  borderColor: 'border-yellow-500', rule: 'Cannot attack or retreat.',                                                                     cure: 'Auto-removed at end of this player\'s next turn. Or Evolve.' },
  confused:   { condition: 'confused',   label: 'Confused',  emoji: '😵', color: 'text-pink-300',   bgColor: 'bg-pink-900',    borderColor: 'border-pink-500',   rule: 'To attack: flip — tails: 30 dmg to own Active, attack fails.',                                  cure: 'Retreat, Evolve, or apply another Special Condition.' },
};
