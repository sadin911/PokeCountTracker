...
export function BottomNav() {
  ...
  const tabs: {
  ...
  }[] = [
    {
      ...
      label: 'สมุดสะสม',
      icon: '📚',
      activeGradient: 'from-yellow-400 via-amber-400 to-yellow-500',
    ...
    },
    {
      ...
      activeGradient: 'from-blue-600 via-blue-500 to-indigo-600',
    ...
    },
    {
      ...
      label: 'Battle',
      icon: '🎮',
      activeGradient: 'from-red-600 via-rose-500 to-red-500',
